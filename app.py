...
# --- Google Drive model IDs (replace with your own IDs) ---
text_model_id = "1uVzRVVMEsdIxw7pItqiWN3RI_Mgp8GRQ"
image_model_id = "1mq6HKFdE2cjNnrhp5f4ROKA4RRCrFxIr"
tokenizer_id   = "YOUR_TOKENIZER_FILE_ID"  # 👈 Upload tokenizer.pkl to Drive & replace this ID
...
text_model, image_model, tokenizer = load_resources()
